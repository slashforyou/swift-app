      ...
      <View style={{ flex: 1, backgroundColor: colors.background }}>
        ...
        <ScrollView style={{ flex: 1, padding: DESIGN_TOKENS.spacing.lg }}>
          ...
          <Card padding="lg" style={{ marginBottom: DESIGN_TOKENS.spacing.lg }}>
            ...
            >
              {t("invoiceEdit.clientInfo")}
            </Text>

            <Input
              label={t("invoiceEdit.clientName")}
            ...
            <Input
              label={t("invoiceEdit.clientEmail")}
          ...
          <Card padding="lg" style={{ marginBottom: DESIGN_TOKENS.spacing.lg }}>
            ...
            >
              {t("invoiceEdit.invoiceDetails")}
            </Text>

            <Input
              label={t("invoiceEdit.invoiceNumber")}
            ...
            <Input
              label={t("invoiceEdit.description")}
          ...
          <Card padding="lg" style={{ marginBottom: DESIGN_TOKENS.spacing.lg }}>
            ...
            >
              ...
              >
                {t("invoiceEdit.elements")} ({(formData.items || []).length})
              </Text>

              <Button
                title={t("invoiceEdit.addBtn")}
                variant="outline"
                size="sm"
            ...
            {(formData.items || []).map((item, index) => (
              ...
              >
                <Input
                  label={t("invoiceEdit.descriptionLabel")}
                  onChangeText={(value) =>
                ...
                >
                  ...
                  >
                    {t("invoiceEdit.total")}: {item.total.toFixed(2)} €
                  </Text>
            ...
            >
              ...
              >
                {t("invoiceEdit.invoiceTotal")}: {formData.amount?.toFixed(2)} €
              </Text>
            </View>
          </Card>
        </ScrollView>
        ...
        >
          ...
          >
            ...
            <Button
              title={
                loading ? t("invoiceEdit.savingBtn") : t("invoiceEdit.saveBtn")
              }
              variant="primary"
              onPress={handleSave}
              disabled={loading}
