...
interface TruckDetailsSectionProps {
    job: any;
    onVehicleUpdated?: (vehicle: { name: string; licensePlate: string } | null) => void;
}

const TruckDetailsSection: React.FC<TruckDetailsSectionProps> = ({ job, onVehicleUpdated }) => {
    ...
    const handleVehicleAssigned = (vehicle: { name: string; licensePlate: string } | null) => {
        if (onVehicleUpdated) {
