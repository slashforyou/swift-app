 ...
 * In production builds (__DEV__ === false), all exports are empty objects.
 */

// @ts-ignore — __DEV__ ternary guards test data from production bundle
export const TEST_DATA: any = __DEV__
  ? {
      /**
...
// @ts-ignore
export const TEST_DATA_ALT: any = __DEV__
  ? {
      personalInfo: {
        firstName: "Sarah",
        lastName: "Thompson",
