...
interface UseBusinessInfoReturn {
  ...
  createNewBusiness: (businessData: Omit<BusinessInfo, 'id' | 'created_at' | 'updated_at'>) => Promise<BusinessInfo | null>;
  updateBusiness: (businessId: string, updates: Partial<BusinessInfo>) => Promise<BusinessInfo | null>;
...
export const useBusinessInfo = (): UseBusinessInfoReturn => {
   ...
   */
  const createNewBusiness = useCallback(async (
