      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <VStack gap="xl">
          ...
          <VStack gap="sm">
            ...
            <Muted>
              Exemple des meilleures pratiques UI mobiles implémentées
            </Muted>
          </VStack>
          ...
          <Card>
            <VStack gap="md">
              ...
              <VStack gap="xs">
                ...
                <Body>
                  Body text (15/20, weight 400) - Texte principal avec retour à
                  la ligne automatique, allowFontScaling activé pour
                  l'accessibilité
                </Body>
                <Muted>
                  Muted text (13/18, weight 400) - Informations secondaires
                </Muted>
              </VStack>
            </VStack>
          </Card>
          ...
          <Card>
            <VStack gap="md">
              ...
              <Body>
                Boutons conformes (height 48pt, hitSlop 8, radius 8) :
              </Body>
              ...
              <Muted>
                ✅ Touch targets ≥44pt selon Apple HIG et Material Design
              </Muted>
            </VStack>
          </Card>
          ...
          <Card>
            <VStack gap="md">
              ...
              <Body>
                Champs uniformisés (height 48pt, radius 8, borders cohérents) :
              </Body>
              ...
              <Muted>
                ✅ États focus visibles, placeholders textMuted,
                allowFontScaling
              </Muted>
            </VStack>
          </Card>
          ...
          <Card>
            <VStack gap="md">
              ...
              <Body>
                Système automatique basé sur les préférences utilisateur :
              </Body>
