...
export default function PaymentsListScreen({
      ...
      >
        ...
        <View style={styles.paymentDetails}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={[styles.detailText, { color: colors.textSecondary }]}>
              {item.method === "card"
                ? t("stripe.payments.creditCard")
                : t("stripe.payments.bankTransfer")}
            </Text>
          </View>
        </View>
      </TouchableOpacity>
  ...
  return (
    <SafeAreaView testID="business-payments-screen" style={styles.container}>
      {/* Header avec bouton retour */}
      <View style={styles.header}>
        <TouchableOpacity
          testID="business-payments-back-btn"
