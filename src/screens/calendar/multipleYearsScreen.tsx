...
const MultipleYearsScreen = ({ navigation }: any) => {
  ...
  const yearCardWidth =
    (screenWidth - DESIGN_TOKENS.spacing.lg * 2 - DESIGN_TOKENS.spacing.md) / 2;
  ...
  return (
    <View style={customStyles.container}>
      ...
      <CalendarHeader navigation={navigation} title={t("calendar.years")} />
          ...
          {yearList.map((year) => {
            ...
            return (
              <Pressable
                ...
                style={({ pressed }) => ({
                  ...(isCurrentYear
                    ? customStyles.yearCardCurrent
                    : customStyles.yearCard),
              ...
              >
                <Text
                  style={
                    isCurrentYear
                      ? customStyles.yearTextCurrent
                      : customStyles.yearText
                  }
                >
                  {year}
                </Text>
                <Text
                  style={
                    isCurrentYear
                      ? customStyles.yearSubtextCurrent
                      : customStyles.yearSubtext
                  }
                >
