  ...
  return (
    ...
    >
      ...
      <View style={styles.section}>
        <Display style={{ color: colors.text }}>Design System Demo</Display>
        <Body
          style={{
            color: colors.textSecondary,
            marginTop: SEMANTIC_SPACING.sm,
          }}
        >
      ...
      <View style={styles.section}>
        ...
        >
          ...
          <CardContent>
            <Body
              style={{ color: colors.success, fontSize: 24, fontWeight: "600" }}
            >
      ...
      <View style={styles.section}>
        ...
        <Input label="Input avec erreur" />

        <Input label="Input avec succès" />

        <Input label="Input désactivé" editable={false} />
      </View>
