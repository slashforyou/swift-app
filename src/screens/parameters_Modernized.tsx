...
const Parameters: React.FC<ParametersProps> = ({ navigation }) => {
  ...
  const SettingItem: React.FC<SettingItemProps> = ({
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        <Caption style={{ color: colors.textSecondary }}>{description}</Caption>
      </View>
  ...
  const themeOptions = [
    { label: t("parametersModernized.appearance.themeLight"), value: "light" },
    { label: t("parametersModernized.appearance.themeDark"), value: "dark" },
    { label: t("parametersModernized.appearance.themeAuto"), value: "auto" },
  ];
  ...
  const notificationSoundOptions = [
    {
      label: t("parametersModernized.soundVibration.notificationSound"),
      value: "default",
    },
      ...
      [
        { text: t("settings.dialogs.resetSettings.cancel"), style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            Alert.alert(
              t("settings.dialogs.resetSuccess.title"),
              t("settings.dialogs.resetSuccess.message"),
            );
          },
        },
      ],
  ...
  return (
    <Screen variant="scroll" style={{ backgroundColor: colors.background }}>
      ...
      >
        ...
        <Title style={{ flex: 1 }}>Paramètres</Title>
      ...
      <View style={{ padding: DESIGN_TOKENS.spacing.lg }}>
        ...
        <SettingSection
          title={t("parametersModernized.sections.notifications")}
          icon="notifications"
        >
          <SettingItem
            label={t("parametersModernized.notifications.enableNotifications")}
            description={t(
              "parametersModernized.notifications.enableNotificationsDesc",
            )}
            icon="phone-portrait"
          ...
          />
          <SettingItem
            label={t("parametersModernized.notifications.messageAlerts")}
            description={t(
              "parametersModernized.notifications.messageAlertsDesc",
            )}
            icon="mail"
          ...
          />
          <SettingItem
            label={t("parametersModernized.notifications.reminderAlerts")}
            description={t(
              "parametersModernized.notifications.reminderAlertsDesc",
            )}
            icon="alarm"
          ...
          />
          <SettingItem
            label={t("parametersModernized.soundVibration.enableSound")}
            description={t(
              "parametersModernized.soundVibration.enableSoundDesc",
            )}
            icon="volume-high"
            value={settings.notifications.soundNotifications}
            onToggle={(value) =>
              updateSetting("notifications", "soundNotifications", value)
            }
        ...
        {/* Section Apparence */}
        <SettingSection
          title={t("parametersModernized.sections.appearance")}
          icon="color-palette"
        >
          <SettingPicker
            label={t("parametersModernized.appearance.theme")}
            description={t("parametersModernized.appearance.themeDesc")}
            icon="contrast"
          ...
          />
          <SettingPicker
            label={t("parametersModernized.appearance.language")}
            description={t("parametersModernized.appearance.languageDesc")}
            icon="language"
          ...
          />
          <SettingPicker
            label={t("parametersModernized.appearance.displayDensity")}
            description={t(
              "parametersModernized.appearance.displayDensityDesc",
            )}
            icon="text"
        ...
        <SettingSection
          title={t("parametersModernized.sections.soundVibration")}
          icon="musical-notes"
        >
          <SettingItem
            label={t("parametersModernized.soundVibration.enableSound")}
          ...
          />
          <SettingItem
            label={t("parametersModernized.soundVibration.enableVibration")}
            description={t(
              "parametersModernized.soundVibration.enableVibrationDesc",
            )}
            icon="phone-portrait"
          ...
          <SettingPicker
            label={t("parametersModernized.soundVibration.notificationSound")}
            description={t(
              "parametersModernized.soundVibration.notificationSoundDesc",
            )}
            icon="musical-note"
            options={notificationSoundOptions}
            selectedValue={settings.sound.notificationSound}
            onValueChange={(value) =>
              updateSetting("sound", "notificationSound", value)
            }
            color={colors.success}
          />
        </SettingSection>
        ...
        <SettingSection
          title={t("parametersModernized.sections.advanced")}
          icon="settings"
        >
          <SettingItem
            label={t("parametersModernized.advanced.dataSync")}
            description={t("parametersModernized.advanced.dataSyncDesc")}
            icon="cloud-upload"
          ...
          />
          <SettingItem
            label={t("parametersModernized.advanced.debugMode")}
            description={t("parametersModernized.advanced.debugModeDesc")}
            icon="code"
            value={settings.advanced.developerMode}
            onToggle={(value) =>
              updateSetting("advanced", "developerMode", value)
            }
            color={colors.error}
          />
        </SettingSection>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Button
                title={t("parametersModernized.closeButton")}
                variant="ghost"
                size="sm"
