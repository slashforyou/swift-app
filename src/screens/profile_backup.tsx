          ...
          <View style={styles.headerContent}>
            <View style={styles.avatarSection}>
              ...
              >
                ...
                >
                  <Text
                    style={[styles.levelText, { color: colors.background }]}
                  >
                    {profile.level || 1}
                  </Text>
                </View>
              ...
              <Text
                style={[styles.experienceText, { color: colors.textMuted }]}
              >
                {profile.experience || 0} /{" "}
                {profile.experienceToNextLevel || 1000} XP to Level{" "}
                {(profile.level || 1) + 1}
              </Text>
            </View>
            <View style={styles.headerInfo}>
              ...
              <View style={styles.titleRow}>
                ...
                <Text style={[styles.userTitle, { color: colors.warning }]}>
                  {profile.title || "Driver"}{" "}
                  {profile.userType === "worker" ? "(ABN)" : "(TFN)"}
                </Text>
              </View>
              <Text
              ...
              {canSeeCompanySection() && profile.companyName && (
                <Text
                  style={[styles.headerCompany, { color: colors.textMuted }]}
                >
                  {profile.companyName}
                </Text>
              )}
        ...
        {canSeeCompanySection() && (
          ...
          >
            ...
            <EditableField
              ...
              placeholder={t("profile.placeholders.siret")}
              editable={isEditing}
            />
            ...
            <EditableField
              ...
              placeholder={t("profile.placeholders.vat")}
              editable={isEditing}
            />
          </View>
        )}
